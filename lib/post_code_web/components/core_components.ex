defmodule PostCodeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PostCodeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PostCodeWeb.Gettext, "errors", msg, opts)
    end
  end
